...
data class UiDataReady(private val dayMapParameter: Map<LocalDate, List<Match>>):
    UiState() {
    val dayMap: Map<LocalDate, List<Match>> = Collections.unmodifiableMap(dayMapParameter)
}
